...
data = data.frame(
  ...
  fga3 = c(
    ofga3 = c(39.05, 30.68, 40.86, 47.31, 36.84, 39.13, 35.23, 20.41, 23, 42.27, 35.35, 38.61, 45.65, 30.93, 38.3, 39.78, 42.55, 42.86, 35.96, 53.41, 44.68, 48.89, 47.25, 47.78), 
    tfga3 = c(44.76, 50, 39.78, 31.52, 36.56, 39.13, 38.64, 48.45, 38.61, 44.79, 33.66, 42.72, 54.35, 41.05, 47.31, 45.16, 57.45, 47.83, 24.72, 33.33, 30.11, 39.33, 33.33, 38.04)
  )
)
...
ggplot(data = data, aes(type, fga3)) +
  geom_jitter(size = 3.5, width = 0.15) +
